...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KDCalendar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC10KDCalendar15CalendarDayCell")
...
SWIFT_CLASS("_TtC10KDCalendar18CalendarFlowLayout")
...
SWIFT_CLASS("_TtC10KDCalendar18CalendarHeaderView")
...
SWIFT_CLASS("_TtC10KDCalendar12CalendarView")
...
@interface CalendarView (SWIFT_EXTENSION(KDCalendar)) <UICollectionViewDelegateFlowLayout>
...
@interface CalendarView (SWIFT_EXTENSION(KDCalendar)) <UICollectionViewDataSource>
